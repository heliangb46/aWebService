...
public class CXFClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MessHolder<ws.com.chinaedu.hel.client.pojo.req.Message, ws.com.chinaedu.hel.client.pojo.res.Message> messHolder = new MessHolder<ws.com.chinaedu.hel.client.pojo.req.Message, ws.com.chinaedu.hel.client.pojo.res.Message>(new ws.com.chinaedu.hel.client.pojo.req.Message(), new ws.com.chinaedu.hel.client.pojo.res.Message());
        ...
        String resXml = checkCardPw.checkCardPw(JaxbUtils.convertToXml(messHolder.reqMes));
        System.out.println(resXml);
        messHolder.resMes = JaxbUtils.converyToJavaBean(resXml, messHolder.resMes.getClass());
