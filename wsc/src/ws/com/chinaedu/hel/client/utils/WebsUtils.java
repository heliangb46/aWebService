...
public class WebsUtils {
	 ...
	 */
    public static <T extends Class<?>, R> R initReqMByClass(T reqMByClass) throws InstantiationException, IllegalAccessException, IllegalArgumentException, SecurityException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
	 ...
	 * @throws NoSuchMethodException
	 */
    public static <R> R getReqMByFactory(Object of) throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
