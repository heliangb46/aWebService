...
public class CheckCardPwServiceImpl implements ICheckCardPwService {
	 ...
	 */
	@Override
	public ws.com.chinaedu.hel.server.sei.imp.pojo.res.Message doCheckCardPw(
			MessHolder<ws.com.chinaedu.hel.server.sei.imp.pojo.req.Message, ws.com.chinaedu.hel.server.sei.imp.pojo.res.Message> messHolder) {
		...
		if (activateCode == null || ("").equals(activateCode)) {
			...
			messHolder.resMes.getHead().getResponse()
					.setBusinessRespCode(IDocWebsConstants.Message_Header_businessRespCode_01);
