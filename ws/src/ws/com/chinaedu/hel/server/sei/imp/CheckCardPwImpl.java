...
@Controller
public class CheckCardPwImpl extends SpringBeanAutowiringSupport implements CheckCardPw {
    ...
    public String checkCardPw(@WebParam(name = IDocWebsConstants.websType_message) String message) throws Exception {
        ...
        MessHolder<ws.com.chinaedu.hel.server.sei.imp.pojo.req.Message, ws.com.chinaedu.hel.server.sei.imp.pojo.res.Message> messHolder = new MessHolder<ws.com.chinaedu.hel.server.sei.imp.pojo.req.Message, ws.com.chinaedu.hel.server.sei.imp.pojo.res.Message>(new ws.com.chinaedu.hel.server.sei.imp.pojo.req.Message(), new ws.com.chinaedu.hel.server.sei.imp.pojo.res.Message());
        ...
        if (enable) {
            ...
            try {
                ...
                WebsUtils.dealwithAnsResHeader(messHolder.resMes.getHead()
                        .getResponse(), IDocWebsConstants.Message_Header_businessRespCode_01, IDocWebsConstants.webs_error_str_001);
                logger.error("ServiceException=异常(cast), ClassName=[" + this.getClass().getName() + "] " + IDocWebsConstants.webs_error_str_001 + e);
                // websLog.setExceptionInf(IDocWebsConstants.webs_error_str_001 + e.getClass().getName());
            }
            // 将请求报文转化为对应的bean----------------------end----------------------
            ...
            try {
                ...
                WebsUtils.dealwithAnsResHeader(messHolder.resMes.getHead()
                        .getResponse(), IDocWebsConstants.Message_Header_businessRespCode_01, IDocWebsConstants.webs_error_str_002);
